...
/*
DeleteAccessApikeyID deletes API key deletes an API key given its ID

DeleteAPIKey deletes an API Key given its ID
*/
...
/*
GetAccessApikey lists API key lists all API keys for a user

ListAPIKey lists all API Keys for a user
*/
...
/*
GetAccessApikeyName gets API key gets information about a specific API key given its name

GetAPIKey gets information about a specific API Key given its name
*/
...
/*
PostAccessApikeyName creates API key creates a new API key
